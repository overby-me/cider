...
//!
//! Each op is a thin call into xnu-sys's hand-written `xnu_sys_psynch_*` (psynch.c), which
...
use crate::xnu::psynch::{
    xnu_sys_psynch_cvbroad, xnu_sys_psynch_cvclrprepost, xnu_sys_psynch_cvsignal, xnu_sys_psynch_cvwait,
    xnu_sys_psynch_mutexdrop, xnu_sys_psynch_mutexwait, xnu_sys_psynch_rw_rdlock,
    xnu_sys_psynch_rw_unlock, xnu_sys_psynch_rw_wrlock,
};
...
pub unsafe fn cvbroad(cv: u64, cvlsgen: u64, cvudgen: u64, flags: u32, mutex: u64, mugen: u64, tid: u64, retval: *mut u32) -> i32 {
    xnu_sys_psynch_cvbroad(cv, cvlsgen, cvudgen, flags, mutex, mugen, tid, retval)
}
...
pub unsafe fn cvclrprepost(cv: u64, cvgen: u32, cvugen: u32, cvsgen: u32, prepocnt: u32, preposeq: u32, flags: u32, retval: *mut u32) -> i32 {
    xnu_sys_psynch_cvclrprepost(cv, cvgen, cvugen, cvsgen, prepocnt, preposeq, flags, retval)
}
...
pub unsafe fn cvsignal(cv: u64, cvlsgen: u64, cvugen: u32, threadport: i32, mutex: u64, mugen: u64, tid: u64, flags: u32, retval: *mut u32) -> i32 {
    xnu_sys_psynch_cvsignal(cv, cvlsgen, cvugen, threadport, mutex, mugen, tid, flags, retval)
}
...
pub unsafe fn cvwait(cv: u64, cvlsgen: u64, cvugen: u32, mutex: u64, mugen: u64, flags: u32, sec: i64, nsec: u32, retval: *mut u32) -> i32 {
    xnu_sys_psynch_cvwait(cv, cvlsgen, cvugen, mutex, mugen, flags, sec, nsec, retval)
}
...
pub unsafe fn mutexdrop(mutex: u64, mgen: u32, ugen: u32, tid: u64, flags: u32, retval: *mut u32) -> i32 {
    xnu_sys_psynch_mutexdrop(mutex, mgen, ugen, tid, flags, retval)
}
...
pub unsafe fn mutexwait(mutex: u64, mgen: u32, ugen: u32, tid: u64, flags: u32, retval: *mut u32) -> i32 {
    xnu_sys_psynch_mutexwait(mutex, mgen, ugen, tid, flags, retval)
}
...
pub unsafe fn rw_rdlock(rwlock: u64, lgenval: u32, ugenval: u32, rw_wc: u32, flags: i32, retval: *mut u32) -> i32 {
    xnu_sys_psynch_rw_rdlock(rwlock, lgenval, ugenval, rw_wc, flags, retval)
}
...
pub unsafe fn rw_unlock(rwlock: u64, lgenval: u32, ugenval: u32, rw_wc: u32, flags: i32, retval: *mut u32) -> i32 {
    xnu_sys_psynch_rw_unlock(rwlock, lgenval, ugenval, rw_wc, flags, retval)
}
...
pub unsafe fn rw_wrlock(rwlock: u64, lgenval: u32, ugenval: u32, rw_wc: u32, flags: i32, retval: *mut u32) -> i32 {
    xnu_sys_psynch_rw_wrlock(rwlock, lgenval, ugenval, rw_wc, flags, retval)
}
