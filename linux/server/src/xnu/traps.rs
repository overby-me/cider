...
#[no_mangle]
pub unsafe extern "C" fn dtape_task_self_trap() -> u32 {
    task_self_trap(ptr::null_mut()) as u32
}

#[no_mangle]
pub unsafe extern "C" fn dtape_host_self_trap() -> u32 {
    host_self_trap(ptr::null_mut()) as u32
}

#[no_mangle]
pub unsafe extern "C" fn dtape_thread_self_trap() -> u32 {
    thread_self_trap(ptr::null_mut()) as u32
}

#[no_mangle]
pub unsafe extern "C" fn dtape_mach_reply_port() -> u32 {
    mach_reply_port(ptr::null_mut()) as u32
}

#[no_mangle]
pub unsafe extern "C" fn dtape_thread_get_special_reply_port() -> u32 {
    thread_get_special_reply_port(ptr::null_mut()) as u32
}

#[no_mangle]
pub unsafe extern "C" fn dtape_mk_timer_create() -> u32 {
