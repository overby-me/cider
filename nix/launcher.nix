# The Rust rewrite of the cider launcher (src/linux/startup/cider.c), task #64. A plain
...
rustPlatform.buildRustPackage {
  ...
  src = src + "/src/linux/launcher";
  cargoLock.lockFile = src + "/src/linux/launcher/Cargo.lock";
