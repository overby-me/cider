...
#
#   scripts/buck-lowering-invariance-check.nu --save before.json    # before your change
#   scripts/buck-lowering-invariance-check.nu --against before.json # after it
#   scripts/buck-lowering-invariance-check.nu --against before.json --expect-changes
#
