...
#     env("X")               the bare helper in src/linux/server
...
# four idioms reported 39 names, 38 of them false: C macros in src/darwin/xtrace, the CIDER_GIT_* pair
...
# Where we talk to people or drive the build. src/darwin/ and src/linux/ are deliberately absent:
...
const READING_DIRS = ["src" "src/darwin" "src/linux" "scripts" "nix" "tests" "buck" "tools" "etc"]
