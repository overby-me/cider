...
#
#     Unknown target `darling_config` from package `root//src/darwin/include`
#     Available targets: root//src/darwin/include:cider_config
#
...
#
#     Unknown target `darling_config` from package `root//src/darwin/include`
#     Unknown target `libsimple_darling` from package `root//src/darwin/libsimple`
#
...
# //vendor/pins/darlingserver, 10 of //src/darwin/include:darling_config and 5 of
# //src/darwin/libsimple:libsimple_darling. Clean now, except two labels ignored by name
# below.
#
