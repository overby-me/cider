...
#
# Usage:  scripts/checks/buck-launchd-check.nu [--prefix <dir>] [<scratch dir>]
...
def main [--prefix: string = "", scratch?: string] {
    ...
    # Only $rt. The prefix directory must NOT be pre-created: cider treats an existing CIDERPREFIX
