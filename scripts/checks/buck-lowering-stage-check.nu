...
#
# Usage:
#   scripts/checks/buck-lowering-stage-check.nu                 # build the current one and check it
#   scripts/checks/buck-lowering-stage-check.nu --script <path> # check a specific staging script
#   scripts/checks/buck-lowering-stage-check.nu --endpoint .#cider-buck2-prefix.stageProject
