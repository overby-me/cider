...
# is what happened with X11 (task 36) and then src/linux/types.h (task 38).
#
...
#
# Usage:  scripts/checks/buck-nix-includes-check.nu
...
const TARGETS = [
    ...
    "//src/darwin/frameworks:OpenGL_obj"
    "//src/darwin/frameworks:fseventsd_obj"
    "//src/darwin/CoreAudio:CoreAudio_obj"
    "//src/darwin/CoreAudio:AudioToolbox_obj"
    "//src/darwin/CoreAudio:AFAVFormatComponent_obj"
]
