...
# links in src/darwin/Developer, which are dangling BY DESIGN here and resolve in the build, and
...
const SDK_MAPS = [
  ...
  ["sdk_framework_darwin_Developer.bzl" "src/darwin/Developer"]
]
...
def main [] {
  ...
  for src in [
    ...
    # lexists, not exists: src/darwin/Developer is a tree of symlinks written for the STAGED layout,
