...
# src/darwin/loader/src/main.rs, strips the root prefix so the path resolves in the guest.
#
...
#
#   scripts/checks/buck-rpath-check.nu [--binary <probe>] [--lib <dylib>] [--art <prefix artifact>]
#
...
# exit 3, which scripts/checks/buck-runtime-check.nu treats as a known partial state rather than a
...
def main [
    ...
    if $rc1 != 0 {
        ...
        say "      See src/darwin/loader/src/main.rs and the executable_path= note at the top."
        exit 1
    }
