...
#
#   scripts/checks/buck-specs-check.nu                       # against .#cider-buck2-graph-min
#   scripts/checks/buck-specs-check.nu --endpoint .#other    # against another graph
#   scripts/checks/buck-specs-check.nu --controls            # and prove the check can fail
#
...
# src/linux/buildtools/graph-specs/src/specscheck.rs.
...
def main [
  ...
  $env.CIDER_REPO = ($env.FILE_PWD | path dirname | path dirname)
