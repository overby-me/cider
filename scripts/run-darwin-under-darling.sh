#!/usr/bin/env bash
# run-darwin-under-darling.sh — run a host Nix-store x86_64-darwin binary under
...
#
# Usage:
#   scripts/run-darwin-under-darling.sh [--darling <darling-bin>] \
