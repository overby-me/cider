/*
 * libswiftSpatial: A SWIFT OVERLAY THIS PORT DOES NOT HAVE, sized by what an application binds.
 *
...
const char cider_shim_libswiftSpatial[] = "cider shim libswiftSpatial";
