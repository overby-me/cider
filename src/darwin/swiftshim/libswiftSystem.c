/*
 * libswiftSystem: A SWIFT OVERLAY THIS PORT DOES NOT HAVE, sized by what an application binds.
 *
...
const char cider_shim_libswiftSystem[] = "cider shim libswiftSystem";
