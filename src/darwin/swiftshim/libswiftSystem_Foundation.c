/*
 * libswiftSystem_Foundation: A SWIFT OVERLAY THIS PORT DOES NOT HAVE, sized by what an application binds.
 *
...
const char cider_shim_libswiftSystem_Foundation[] = "cider shim libswiftSystem_Foundation";
