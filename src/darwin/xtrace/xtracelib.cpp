...
static void xtrace_setup_mach(void)
{
	...
	setup_hook(_darling_mach_syscall_entry, (void*)cider_mach_syscall_entry_trampoline, false);
	setup_hook(_darling_mach_syscall_exit, (void*)cider_mach_syscall_exit_trampoline, false);
...
static void xtrace_setup_bsd(void)
{
	...
	setup_hook(_darling_bsd_syscall_entry, (void*)cider_bsd_syscall_entry_trampoline, false);
	setup_hook(_darling_bsd_syscall_exit, (void*)cider_bsd_syscall_exit_trampoline, false);
