 ...
 * that occur on the server side (in ciderd). This is necessary
 ...
 *   3. our filter handler opens a kqchan using a ciderd RPC call.
 *   4. ciderd sets up the kqchan on the server side and sends back a socket
