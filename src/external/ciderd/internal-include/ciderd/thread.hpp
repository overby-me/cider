...
#include <ciderd/message.hpp>
#include <ciderd/xnu-sys.h>
#include <ciderd/logging.hpp>
#include <ciderd/stack-pool.hpp>
#include <ciderd/registry.hpp>
...
namespace DarlingServer {
	...
	public:
		...
		/**
		 * The TID of this Thread as seen from ciderd's namespace.
		 */
		ID id() const;
		 ...
		 * point. Implements the ciderd side of __pthread_markcancel.
		 */
		void markCanceled();
