...
//!     carries it. scripts/checks/buck-argv-roundtrip-check.nu holds both halves of that. See unjoin.
...
fn main() {
    ...
    //     //src/darwin/include:cider_config, reachable through no subtarget, and it simply went
