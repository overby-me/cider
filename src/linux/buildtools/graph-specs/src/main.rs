...
//!
//! This is src/linux/buildtools/graph-specs and src/linux/buildtools/graph-specs in one binary. They were
...
//! buck2 was just run on. See src/linux/buildtools/skeleton for the same constraint.
//!
...
//! literal.
//!
//! VERIFIED against src/linux/buildtools/graph-specs over the REAL 147 MB graph, 1,474 groups and
