...
//!
//! ====================================================================================
//! PORTED FROM src/linux/buildtools/skeleton (#99), and it is the FIRST build-path script to move
...
const NEVER_EMPTY_FILES: &[&str] = &[
    ...
    "src/darwin/libsimple/include/libsimple/base.h",
    "src/darwin/libsimple/include/libsimple/lock.h",
    "src/darwin/libsimple/src/lock.c",
