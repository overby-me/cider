...
APPKIT_EXPORT NSString *const NSAccessibilityTabButtonSubrole;
...
/* Undocumented */
APPKIT_EXPORT NSString *const NSAccessibilityEventProcessedNotification;
APPKIT_EXPORT NSString *const NSAccessibilityEventSourceProcessIDKey;
APPKIT_EXPORT NSString *const NSAccessibilityEventSourceStateIDKey;
